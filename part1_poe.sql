-- =============================================
-- RaceDay System — SSMS Database Script
...
CREATE TABLE EventEnrolment (
    ...
    enrolment_date DATE DEFAULT GETDATE(),
...
-- =============================================
-- SEED DATA
-- Min: 2 Organisers, 2 Participants, 3 Events, Categories, Enrolments
-- =============================================
...
-- Users (password hashes shown as placeholders — use real hashes in production)
...
('00:28:15', 5, 'First 5K race', 3);

PRINT '✅ RaceDayDB created successfully with seed data.';
